...
# -*- coding: utf-8 -*-
#
# DataDigitizer documentation build configuration file, created by
# sphinx-quickstart on Fri Apr 03 05:24:00 2020.
#
...
# html_static_path = ['./scipy-sphinx-theme/_static']


# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'datadigitizerdoc'
